...
1. Aktivnost (2014 in 2019)
  - država
  - delež prebivalcev, ki hodi
  - -||-, ki kolesari
  - -||-, ki se ukvarja z aerobični športi
  - -||-, ki se ukvarja s treningi za moč
...
V prvem grafu sem prikazala spremembo v fizični aktivnosti posameznih državah
```{r graf1, echo=FALSE, fig.align='center', warning=FALSE}
plot(graf1)
```

V drugem pa, koliko se je spremenil delež prebivalstva z normalnim BMI
...
Prav pri zgornjih treh državah se lepo vidi, da se je zdravje (razen pri kazalniku bolniška) izboljšalo, ko so bili bolj fizično aktivni.
