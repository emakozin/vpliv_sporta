...
Osmi graf pa koliko se od povprečja razlik pričakovanih let, kolesarjenja in aerobične vadbe razlikujejo vrednosti po posamezni državi
...
Naredila sem linearni napovedni model, ki napoveduje, kakšna naj bi bila razlika v pričakovanih letih glede na kazalnike: kolesarjenje, ocena dobro in aerobična vadba. na grafu sem prikazala tako dejankse kot napovedne vrednosti.
```{r analiza}
...
Izračunala sem še povprečja ocene dobro v letih od 2014 do 2019 po posamezni državi in naredila graf, ki kaže, odstopanja od teh povprečij za vsako leto.
